...
struct NetworkNode
    ...
    NetworkNode(account::String, type::Symbol, name::String, coordinates::LLA, country::String, continent::String, isCommon::Bool, volumeCost::Float64) = new(
        account, type, hash(account, type), name, coordinates, country, continent, isCommon, volumeCost
    )
end
